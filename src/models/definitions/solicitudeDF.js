    ...
    return new Promise((resoleve,reject)=>{
        ...
        const docDefinition = {
            ...
            content: [
                ...
                {
                    text: 'Plazo de entrega _____________________________             Fecha____________________________________',
                    margin: [ 0, 30, 0, 60 ],
                },
                {
                    text: '1 ___________________________________                                 2 ___________________________________',   
                },
                {
                    text: '       Firma del director del abastecimiento                                               Firma y cello del proveedor',   
                },
            ],
            footer:[
