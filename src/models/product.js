import { productAll, productCreate, productUpdate, productDelete, productSearch } from '../services/product';
...
export default {
    ...
    effects: {
        ...
        *update({ payload }, { call, put }){
            ...
            if (response.success){
                ...
                Modal.error({title: 'Error al actualizar el producto', content: response.message});
            }
        },
    ...
    reducers: {
        ...
        updateSuccess(state, { payload }){
            const newList = state.list.map(product => product.id == payload.id ? {...product, ...payload} : product);
