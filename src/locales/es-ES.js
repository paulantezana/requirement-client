export default {
    ...
    'validation.email.required': '¡Por favor introduzca su email!',
    'validation.email.wrong-format': 'La dirección de email está en el formato incorrecto!',
    'validation.password.required': 'Por favor, introduzca su contraseña!',
    'validation.password.twice': 'Las contraseñas no coinciden!',
    ...
    'form.confirm-password.placeholder': 'Confirmar contraseña',
    'form.phone-number.placeholder': 'Número de teléfono',
    'form.verification-code.placeholder': 'Código de verificación',
    'form.title.label': 'Título',
    'form.title.placeholder': 'Dale un nombre al objetivo',
    'form.date.label': 'Fecha de inicio y finalización',
    'form.date.placeholder.start': 'Fecha de inicio',
    'form.date.placeholder.end': 'Fecha final',
    'form.goal.label': 'Descripción del objetivo',
    'form.goal.placeholder': 'Por favor ingrese sus metas de trabajo',
    'form.standard.label': 'Métrica',
    'form.standard.placeholder': 'Por favor ingrese una métrica',
    'form.client.label': 'Cliente',
    'form.client.label.tooltip': 'Objeto de servicio de destino',
    'form.client.placeholder':
        'Describa su servicio al cliente, clientes internos directamente @ Nombre / número de trabajo',
    'form.invites.label': 'Criticas invitadoras',
    'form.invites.placeholder':
        'Por favor, dirija @ Nombre / número de trabajo, puede invitar hasta 5 personas',
