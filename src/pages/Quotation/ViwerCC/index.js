        ...
        return (
            <Card bordered={false} className={stateCard}>
                <div className={styles.header}>
                    ...
                    <Button disabled={enabledButtonCC} icon="printer" onClick={() => onPrintCC()}>
                        Cuadro Comparativo
                    </Button>
                    <CuadroComparativo />

                    {/* Imprimir orden de compra */}
                    <Button disabled={enabledButtonOC} icon="printer" onClick={() => onPrintOC()}>
                        Orden De Compra
                    </Button>
                    <OrdenCompra />

                    {/* Imprimir Comprobante de pago */}
                    <Button icon="printer" onClick={() => onPrintCP()}>
                        Comprobante De Pago
                    </Button>
                    <CPModal />

                    {/* Imprimir memorandum */}
                    <Button icon="printer" onClick={() => onPrintMemo()}>
                        Memorandum
                    </Button>
                    <MemoModal />

                    {/* Imprimir pedido comprobante de salida */}
                    <Button icon="printer" onClick={() => onPrintPecosa()}>
                        Pecosa
                    </Button>
                    <PecosaModal />
                </div>
