                                ...
                                <Form.Item hasFeedback {...formItemLayout} label="Destino">
                                    {getFieldDecorator('destination', {
                                        ...
                                        rules: [
                                            {
                                                required: true,
                                                message: '¡Por favor ingrese un destino!',
                                            },
                                        ],
                                ...
                                <Form.Item hasFeedback {...formItemLayout} label="Solicitante">
                                    {getFieldDecorator('claimant', {
                                        ...
                                        rules: [
                                            {
                                                required: true,
                                                message: '¡Por favor ingrese un solicitante!',
                                            },
                                        ],
                                    })(
...
class ModalForm extends Component {
    ...
    render() {
        ...
        const { currentItem, modalType, modalVisible } = requirement;
