...
export default class PageHeader extends PureComponent {
    constructor(props){
        ...
        this.getBreadcrumbDom = this.getBreadcrumbDom.bind(this);
        this.conversionFromProps = this.conversionFromProps.bind(this);
        this.conversionFromLocation = this.conversionFromLocation.bind(this);
        this.conversionBreadcrumbList = this.conversionBreadcrumbList.bind(this);
