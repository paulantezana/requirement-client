...
import { message, Button, Form, Input, Upload, Icon, Tooltip, InputNumber, Radio, Modal, Card } from 'antd';
        ...
        render(){
            ...
            return (
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <Form.Item label="Cotizaciones" help="Número maximo cotizaciones que se pueden realizar en un requerimiento">
                        {getFieldDecorator('quotations', {
                            initialValue: setting.quotations,
                            rules: [
                                { pattern: /^([1-9]|1[0-5])$/, message: '¡Solo se permiten valores numéricos de 1 a 15!' },
                                { required: true, message: '¡Por favor ingrese un número!' }
                            ],
                        })(
