...
class Quotation extends Component{
    ...
    render(){
        ...
        const stateCard = stateAux === '4' ? styles.close : 
            (stateAux === '3' ? styles.accepted : 
            (stateAux === '2' ? styles.rejected :
            (stateAux === '1' ?  styles.process :  styles.check  )));

        // Enabled or disabled buttons    
        const enabledButtonPlus = !(requirementItem.state === "1" || requirementItem.state === "0");
        const enabledButtonNull = !(requirementItem.state === "1" || requirementItem.state === "0" || requirementItem.state === "3");
                ...
                <Card bordered={false} className={stateCard}>
                    <div className={styles.header}>
                        ...
                        <Button 
                            ...
                            disabled={enabledButtonPlus}>Insertar cotizacion</Button>
                        <Button disabled={enabledButtonNull} icon="close" onClick={()=>{
                            Modal.confirm({
