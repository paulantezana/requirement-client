...
class DataList extends Component{
    ...
    render(){
        ...
        const columns = [
            {
                title: (<div> ARTÍCULO   <Tag color="blue">1</Tag></div>),
                children: [
                    {
                        title: (<div>N° <Tag color="green">A</Tag></div>),
                        dataIndex: 'num',
                        key: 'num',
                        width: '70px'
                    },
                    {
                        title: (<div>Descripcion <Tag color="green">B</Tag></div>),
                        dataIndex: 'name',
                        key: 'name',
                    },
                    {
                        title: <div>Cantidad <Tag color="green">C</Tag></div>,
                        dataIndex: 'amount',
                        key: 'amount',
                    },
                    {
                        title: (<div>Unidad de medida <Tag color="green">D</Tag></div>),
            ...
            {
                title: (<div>PRECIOS NETOS   <Tag color="blue">2</Tag></div>),
                children: [
                    {
                        title: (<div>Unitario <Tag color="cyan">A</Tag></div>),
                        dataIndex: 'price1',
                        key: 'price1',
                    },
                    {
                        title: (<div>Total <Tag color="cyan">B</Tag></div>),
                        key: 'total1',
                        render: (a, record)=>{
                            if(a.price1){
                    ...
                    {
                        title: (<div>Unitario <Tag color="gold">A</Tag></div>),
                        dataIndex: 'price2',
                        key: 'price2',
                    },
                    {
                        title: (<div>Total <Tag color="gold">B</Tag></div>),
                        key: 'total2',
                        render: (a, record)=>{
                            if(a.price2){
                    ...
                    {
                        title: (<div>Unitario <Tag color="red">A</Tag></div>),
                        dataIndex: 'price3',
                        key: 'price3',
                    },
                    {
                        title: (<div>Total <Tag color="red">B</Tag></div>),
                        key: 'total3',
                        render: (a, record)=>{
                            if(a.price3){
