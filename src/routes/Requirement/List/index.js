        ...
        const columns = [
            ...
            },
            {
                ...
                render: (a, record)=>{
                    switch (a.state) {
                        case '0':
                            return <span className={styles.check}><Badge status="warning"/> Revisar</span>
                        case '1':
                            return <span className={styles.process}><Badge status="processing"/> Proceso</span>
                        case '2':
                    ...
                    return (
                        <div className={styles.actions}>
                            ...
                            }
                            {
                                a.state !== "0" &&
                                <Tooltip title="Ver">
                                    <Icon type="eye-o" className={styles.update} onClick={()=>onShowModalEdit('detail',a)}/>
                                </Tooltip>
                            }
                            <Tooltip title="Imprimir">
                                <Icon type="printer" className={styles.printer} onClick={()=>onShowPrinter(a)}/>
                            </Tooltip>
